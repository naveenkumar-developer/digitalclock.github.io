...
if (z < 12) {
  bgimg.style.backgroundImage = "url('./images/morning.png')";
  bgimg.style.backgroundSize = "cover";
} else if (z < 16) {
  bgimg.style.backgroundImage = "url('./images/afternoon.jpg')";
  bgimg.style.backgroundSize = "cover";
} else if (z < 19) {
  bgimg.style.backgroundImage = "url('./images/evening.jpg')";
  bgimg.style.backgroundSize = "cover";
} else {
  bgimg.style.backgroundImage = "url('./images/night.png')";
  bgimg.style.backgroundSize = "cover";
}
